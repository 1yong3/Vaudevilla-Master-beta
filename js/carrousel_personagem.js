...
const factions = {
  ...
  magicos: [
    ...
    { icon: './Img/Luara_icone.png', name: 'Luara', desc: 'Luara é uma cartomante amiga da Trupe, ela faz o papel da seriedade, o pé no chão que traz o bom senso para palhaços. Ela vem de uma familia ancestral de cartomantes profetas que costumam prever as verdades desagradaveis que ninguém quer ouvir, muitas vezes sentindo o peso de suas previsões.' }
  ]
};
